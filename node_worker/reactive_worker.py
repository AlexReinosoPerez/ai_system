...
class ReactiveWorker:
    ...
    def _code_fix_exists(self, source_dds_id: str) -> bool:
        ...
        try:
            ...
            for proposal in proposals:
                # Check if it's a code_fix for this source DDS
                proposal_dict = proposal.to_dict()
                if (proposal_dict.get('type') == 'code_fix' and
                    proposal_dict.get('source_dds') == source_dds_id):
                    return True
    ...
    def _save_code_fix(self, code_fix_dds: Dict):
        """Save code_fix DDS to registry"""
        # Convert to DDSProposal
